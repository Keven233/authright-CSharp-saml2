...
using com.authright.saml2.Validation;

namespace com.authright.saml2
{
    ///<summary>
    ...
    public class Saml20Assertion 
    {
        ...
        public void Sign(X509Certificate2 cert)
        {
            ...
            while( (sigNode = signatureParentNode.GetElementsByTagName(com.authright.saml2.Schema.XmlDSig.Signature.ELEMENT_NAME,
